...
struct WindowTransition
{
    ...
    WindowTransition() :
        ...
        endAlpha(1),
        startDelay(0),
        easingCurve(0.25f, 0.1f, 0.25f, 1.0f),
        isComplete(false) {
    }
};
...
enum class TransitionStyle
{
    SMOOTH_SLIDE, BOUNCE_IN, ELASTIC_OUT, CASCADE_WAVE, SPIRAL_MOTION, MAGNETIC_ATTRACT, LIQUID_FLOW
};
...
public:
    explicit AnimationSystem(float baseDuration = 0.8f,
                             float maxStagger = 0.3f);
